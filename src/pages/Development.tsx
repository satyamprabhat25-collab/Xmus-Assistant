...
import { Code, ArrowLeft, Lock, ExternalLink, TrendingUp, Terminal, GitBranch, Globe, Sparkles, Box, Cpu } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container max-w-7xl mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-6">
              Build <span className="bg-gradient-to-r from-slate-500 to-zinc-500 bg-clip-text text-transparent">Amazing</span> Things
            </h1>
      ...
      <section className="container max-w-7xl mx-auto px-4 py-12">
        <h2 className="font-display font-bold text-2xl md:text-3xl mb-8 flex items-center gap-3">
          <Terminal className="h-8 w-8 text-slate-500" /> Developer Tools
        </h2>
          ...
          {devToolsLinks.map(link => (
            <a key={link.id} href={link.url} onClick={(e) => handleLinkClick(e, link.url, link.premium || false, link.title)}
              ...
              <div className="p-3 md:p-4">
                <h3 className="font-semibold text-sm md:text-base mb-1 group-hover:text-slate-500 transition-colors">{link.title}</h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs md:text-sm font-medium text-slate-500 flex items-center gap-1">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="font-display font-bold text-xl mb-6 flex items-center gap-3">
                <Cpu className="h-6 w-6 text-slate-500" /> Learn to Code
              </h2>
              <div className="space-y-4">
                {learningLinks.map(link => (
                  <a key={link.id} href={link.url} onClick={(e) => handleLinkClick(e, link.url, link.premium || false, link.title)}
                    ...
                    <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-slate-500 to-zinc-600 flex items-center justify-center shrink-0">
            ...
            <div>
              <h2 className="font-display font-bold text-xl mb-6 flex items-center gap-3">
                <Box className="h-6 w-6 text-slate-500" /> Frameworks
              </h2>
              <div className="space-y-4">
